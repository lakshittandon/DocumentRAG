...
- Set `OLLAMA_BASE_URL=http://localhost:11434` and `OLLAMA_MODEL=qwen2.5:0.5b` to use the local Ollama path. For Ollama Cloud, set `OLLAMA_BASE_URL=https://ollama.com`, `OLLAMA_API_KEY`, and a cloud-available model such as `gemma3:4b`.
